  ...
  const items = [
    { label: "Body", sub: "Faster. Stronger.", anim: "0.4s", icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <circle cx="50" cy="20" r="10" fill="#b14dff" />
        <path d="M40 32 L60 32 L70 60 L60 65 L55 50 L60 90 L52 92 L46 60 L40 92 L34 90 L38 50 L34 65 L24 60 Z" fill="#b14dff" />
      </svg>
    )},
    { label: "Sense", sub: "Sharper. Clearer.", anim: "0.7s", icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <ellipse cx="50" cy="50" rx="44" ry="22" fill="none" stroke="#b14dff" strokeWidth="4" />
        <circle cx="50" cy="50" r="14" fill="#b14dff" />
        <circle cx="54" cy="46" r="4" fill="#07030f" />
      </svg>
    )},
    { label: "Mind", sub: "Smarter. Calmer.", anim: "1s", icon: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <path d="M30 30 Q20 30 20 45 Q15 50 20 60 Q20 75 35 78 Q40 88 50 85 Q60 88 65 78 Q80 75 80 60 Q85 50 80 45 Q80 30 70 30 Q65 20 50 22 Q35 20 30 30 Z" fill="none" stroke="#b14dff" strokeWidth="3" />
        <path d="M50 22 L50 85" stroke="#b14dff" strokeWidth="2" />
      </svg>
    )},
  ];
  return (
      ...
      <div className="absolute top-[44vh] left-[6vw] right-[6vw] grid grid-cols-3 gap-[3vw]">
        {items.map((it, i) => (
          <div key={it.label}
            ...
            <div className="w-[55%] h-[55%]" style={{ filter: "drop-shadow(0 0 14px #b14dff)" }}>{it.icon}</div>
